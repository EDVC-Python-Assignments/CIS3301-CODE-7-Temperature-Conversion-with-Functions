...
from code_7 import get_temperature_in_kelvin
...
def test_conversion_farenheit_to_celcius():
...
def test_conversion_farenheit_to_kelvin():
    ...
    temp_in_c = random_temp_in_c + 273.15
    assert temp_in_c == get_temperature_in_kelvin(random_temp_in_c)
...
def test_clothing_recommendation():
    ...
    warm_item = get_clothing_recommendation(random.randint(16,24))
    hot_item = get_clothing_recommendation(random.randint(25,35))
